...
export const imageLoader = {
    ...
    // Теперь мы не вызываем revoke часто, 
    // так как хотим держать ссылки стабильными пока приложение запущено
    revokeUrl(url) {
        // Опционально: можно реализовать логику очистки по времени
    }
};